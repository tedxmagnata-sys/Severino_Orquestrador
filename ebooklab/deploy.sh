#!/bin/bash
# =============================================================================
#  EbookLab Engine v1.0 — Deploy legado (rota severinobot.com/leadbook)
#  Para o novo domínio (ebooklab.severinobot.com), use deploy-ebooklab.sh.
#  Este script mantém a rota antiga /leadbook no site nginx "severino".
