document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateThermometerUI() {
      ...
      function updateCountdownDisplay() {
        ...
        const tier = license.tier === 'vip' ? 'VIP' : 'BÃ¡sico';
...
async function validateLicense() {
  try {
      ...
      if (saveBtn) {
        saveBtn.addEventListener('click', () => {
          ...
          const cfg = {
            ...
            aporteSchedule: (document.getElementById('st-aporte-schedule') || {}).value || 'off',
            aporteAmount: Math.max(5, Number((document.getElementById('st-aporte-amount') || {}).value) || 5),
            aporteDay: Number((document.getElementById('st-aporte-day') || {}).value) || 1,
            cards: cards
          };
    ...
    function stLoadConfigIntoModal() {
      ...
      set('st-aporte-schedule', cfg.aporteSchedule || 'off');
      set('st-aporte-amount', cfg.aporteAmount || 5);
      set('st-aporte-day', cfg.aporteDay !== undefined ? cfg.aporteDay : 1);
