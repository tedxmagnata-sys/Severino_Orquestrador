/**
 * LeadBook Engine — Servidor HTTP (zero dependências)
...
const ADMIN_SECRET = ia.env('ADMIN_SECRET', 'leadbook-admin');
...
const PRODUTO_NOME = ia.env('PRODUTO_NOME', 'LeadBook Engine');
...
http.createServer(async (req, res) => {
  ...
  console.log(`LeadBook Engine v1.0 rodando em http://localhost:${PORT}`);
});
